...
void Server::addWriteEvent(int sockfd)
{
    ...
    EV_SET(&write_event, sockfd, EVFILT_READ, EV_ADD, 0, 0, NULL);
...
{
    struct kevent write_event;
    EV_SET(&write_event, sockfd, EVFILT_READ, EV_DISABLE, 0, 0, NULL);
...
{
    struct kevent write_event;
    EV_SET(&write_event, sockfd, EVFILT_READ, EV_ENABLE, 0, 0, NULL);

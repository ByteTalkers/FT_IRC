...
FILE = Server/Server.cpp Server/utils.cpp \
	...
	Message/nick.cpp Message/pass.cpp Message/user.cpp Message/parsing.cpp Message/whois.cpp Message/mode.cpp Message/ping.cpp Message/join.cpp Message/part.cpp\
	Message/Command.cpp
